...
- A new module for ModemManager got added, available at `networking.modemmanager`. Previously, ModuleManager was configured through `networking.networkmanager`.
